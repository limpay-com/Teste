    ...
    return(
        <div className="w-100 h-100 fundo-inicial d-flex flex-column align-items-center justify-content-between gap-3 ">
            <div className="c-opcoes d-flex flex-column">
                ...
                </p><button className=" i-opcoes" style={{backgroundColor: "white"}}><Link to="/fazendoalimpa" ><FaArrowRight></FaArrowRight></Link></button>
            </div>
            <div className="c-opcoes d-flex flex-column">
                ...
                </p><button className=" i-opcoes" style={{backgroundColor: "white"}}><Link to="/cursosprofissionalizantes" ><FaArrowRight></FaArrowRight></Link></button>
            </div>
