...
function Cadastro() {
  return (
    <div className="d-flex w-100 h-100 align-items-center">
      <div className=" w-100 ">
        <h1 className="m-3 d-flex justify-content-center fw-bold ">
          {' '}
          Faça parte
        </h1>
        <form
          className="px-5 d-flex flex-column mx-5"
          id="forms"
          action="Cadastrar"
          method="post"
        >
          <label className=" mt-2 mx-2 " htmlFor="nome">
            Nome
          </label>
          <input
          ...
          <label className=" mt-2 mx-2" htmlFor="email">
            Email
          </label>
          <input
            className="rounded-3 border border-dark p-2"
          ...
          <label className=" mt-2 mx-2" htmlFor="senha">
            Senha
          </label>
          <input
            className="rounded-3 border border-dark p-2"
          ...
          <label className=" mt-2 mx-2" htmlFor="confirmSenha" id="labelat">
            Confimar Senha
          </label>
          <input
            className="rounded-3 border border-dark p-2 "
          ...
          <button
            className="btn btn-primary rounded-3 border border-light"
